    ...
    <section id="use-cases" className="py-24 sm:py-32 bg-muted/30">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-8 lg:mx-0 lg:max-w-none lg:grid-cols-2">
          {useCases.map((useCase, index) => (
            <motion.div
              ...
              className="relative rounded-2xl border border-border bg-card p-8 hover:shadow-lg transition-shadow group"
            >
              ...
              <button className="mt-6 inline-flex items-center text-sm font-medium text-primary hover:text-primary/80 transition-colors group">
                Learn more
        ...
        <motion.div
          ...
          className="mt-20 rounded-2xl bg-gradient-to-r from-purple-600 to-blue-600 p-8 text-center"
        >
